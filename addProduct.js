...
//<------------------------Button----------------------------------------------------------->
    ...
    document.querySelector('.next-button').addEventListener('click', function() {
        ...
        document.querySelector('.genRectangleBox').classList.add('slide-out-left');
    ...
    document.querySelector('.prev-button').addEventListener('click', function() {
        ...
        document.querySelector('.genRectangleBox').classList.add('slide-out-right');
    ...
    document.getElementById('addProductButton').addEventListener('click', function() {
        ...
        button.style.transform = 'translateY(300px)'; // Slide down
        button.style.opacity = '0'; // Fade out
    
        // Delay navigation to allow animation to complete
        setTimeout(function() {
            window.location.href = 'searchProd.html'; // Navigate to searchProd.html
        }, 300); // 300ms to match animation duration
    });
